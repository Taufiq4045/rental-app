...
const UserCarCard = ({ item, cardtype }) => {
   ...
   // const [carid, setCarid] = useState();
    ...
    const handleSubmit = (e) => {
        ...
        axios({
            method: "post",
            url: "https://drive-well-server.herokuapp.com/car/editcardetails",
            headers: authHeader(),
            data: payload
        }).then((res) => {
            //console.log(res);
    ...
    const deleteCar =() =>{
        ...
        axios({
            method: "delete",
            url: "https://drive-well-server.herokuapp.com/car/deletecardetails",
            headers: authHeader(),
            data: payload
        }).then((res) => {
            console.log(res);
    ...
    const sendResponse = (status, bookingid, carid) => {
        ...
        if (status === 1)
        {
            axios({
                method: 'post',
                url: "https://drive-well-server.herokuapp.com/car/acceptrequestbooking",
                headers: authHeader(),
                data: payload,
            })
            .then((res) => {
        ...
        else if(status === 2)
        {
            axios({
                method: 'post',
                url: "https://drive-well-server.herokuapp.com/car/cancelrequestbooking",
                headers: authHeader(),
                data: payload,
            })
            .then((res) => {
        ...
        else
        {
            axios({
                method: 'post',
                url: "https://drive-well-server.herokuapp.com/car/cancelconfirmedbooking",
                headers: authHeader(),
                data: payload,
            })
                .then((res) => {
