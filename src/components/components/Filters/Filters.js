        ...
        return (
            <div className="filters">
                ...
                <div className="seats-filter">
                    ...
                    <CheckBox labelFor={5} className="seats" onChange={this.eventHandler} values={false} />
                    <CheckBox labelFor={7} className="seats" onChange={this.eventHandler} values={false} />
