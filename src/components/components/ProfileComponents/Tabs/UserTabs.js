...
export const UserTabs = () => {
    ...
    useEffect(() => {
        if (value === 0) {
            axios({
                method: "get",
                url: "https://drive-well-server.herokuapp.com/user/getaddedcar",
                headers: authHeader(),
            }).then((res) => {
                if (res.status === 200) {
            ...
            axios({
                method: "get",
                url: "https://drive-well-server.herokuapp.com/user/getlendedcar",
                headers: authHeader(),
            }).then((res) => {
                if (res.status === 200) {
                    console.log(res.data);
            ...
            axios({
                method: "get",
                url: "https://drive-well-server.herokuapp.com/user/getrentedcar",
                headers: authHeader(),
            }).then((res) => {
                if (res.status === 200) {
                    console.log(res.data);
            ...
            axios({
                method: "get",
                url: "https://drive-well-server.herokuapp.com/user/getrequestedcar",
                headers: authHeader(),
            }).then((res) => {
                if (res.status === 200) {
